            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="col-sm-10">
                            <input type="text" placeholder="Car Name" name="name" required="" class="addinput">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-10">
                            ...
                            <select name="company_id" id="inputStatus" class="form-control custom-select">
                                <option selected Company>Select one</option>
